...
export default function Banner() {
  return (
    <div className="relative bg-[rgb(15,17,22)] px-40 py-28 flex justify-center items-center">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <button className="bg-[rgb(26,104,254)] rounded-full px-12 py-4 text-white font-semibold text-base transition duration-300 ease-in-out hover:bg-[rgb(255,255,255)]">Book an appointment</button>
      </div>
    </div>
  );
}
